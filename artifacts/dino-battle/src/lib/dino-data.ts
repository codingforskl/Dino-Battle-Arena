...
export const STATUS_TOOLTIPS: Record<string, string> = {
  ...
  enraged:     'Desperate Fury — Low HP activates last-stand power! +25% attack.',
};
...
export const DINOSAURS: Record<DinoId, DinoBase> = {
  velociraptor: {
    ...
    hideToughness: 'low',
    abilities: [
      { id: 'sickle_claw',     name: 'Pack Slash',       description: 'Both raptors slash simultaneously with their hooked killing claws',                staminaCost: 10, type: 'attack',  damage: 20 },
      ...
      { id: 'raptor_surround', name: 'Raptor Surround',   description: 'Pack circles the prey from all sides — disorienting strike that stuns the target', staminaCost: 20, type: 'attack',  damage: 18 },
      { id: 'jugular_slash',   name: 'Jugular Slash',     description: 'Razor sickle claw slices the throat — causes bleeding for 3 turns',                staminaCost: 18, type: 'attack',  damage: 14 },
      ...
      { id: 'frenzy_blitz',    name: 'PACK FRENZY',       description: 'Both raptors unleash a relentless 8-slash frenzy — ignores hide entirely',          staminaCost: 46, type: 'attack',  damage: 78, isUltimate: true },
    ]
  },
  giganotosaurus: {
    id: 'giganotosaurus',
  ...
  pterodactylus: {
    ...
    abilities: [
      ...
      { id: 'terror_dive', name: 'Terror Dive',        description: 'All three plunge talons-first at the skull — stuns and deals savage damage',               staminaCost: 20, type: 'attack', damage: 22 },
      ...
      { id: 'screech_dive',name: 'SWARM DIVE BOMB',    description: 'All three dive from altitude at terminal velocity — catastrophic combined impact',           staminaCost: 44, type: 'attack', damage: 78, isUltimate: true },
    ]
  }
};
