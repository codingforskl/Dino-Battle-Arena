...
export const DINOSAURS: Record<DinoId, DinoBase> = {
  hunter: {
    ...
    hideToughness: 'low',
    abilities: [
      { id: 'tail_sweep_giga', name: 'Snare Net',      description: 'Hurls a weighted net — tangles legs and slows the dinosaur',               shortEffect: 'Slows dinosaur 2 turns',           staminaCost: 12, type: 'attack', damage: 42 },
      ...
      { id: 'body_slam',      name: 'Bear Trap',      description: 'Spring-loaded jaw trap snaps shut — stuns the dinosaur 1 turn',             shortEffect: 'Stuns dinosaur 1 turn',            staminaCost: 18, type: 'attack', damage: 38 },
      { id: 'jugular_slash',  name: 'Poison Dart',    description: 'Fires a neurotoxin dart — causes ongoing bleeding damage',                  shortEffect: '🩸 Causes bleeding (3 turns)',      staminaCost: 16, type: 'attack', damage: 30 },
      { id: 'rex_bite',       name: 'Tranq Rifle',    description: 'High-powered tranquilizer blast — powerful stagger',                        shortEffect: 'Powerful heavy hit',               staminaCost: 22, type: 'attack', damage: 80 },
      { id: 'frenzy_blitz',   name: "HUNTER'S GAMBIT",description: 'Unleashes every weapon at once — explosive full assault',                   shortEffect: 'Full hunter arsenal assault',      staminaCost: 46, type: 'attack', damage: 130, isUltimate: true },
    ]
  },
  velociraptor: {
    id: 'velociraptor',
